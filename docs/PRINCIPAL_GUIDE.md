# Principal guide / प्रधानाचार्य मार्गदर्शिका
...
- **School settings** — name, address, phone, email, office hours, facilities,
  social links, principal's message, admission mode, and the CBSE affiliation
  number (leave blank until confirmed — never enter a placeholder).
- **Timings** — one active normal schedule, plus optional temporary overrides.
...
### आपके नियंत्रण में सेटिंग्स
- **विद्यालय सेटिंग्स** — नाम, पता, फ़ोन, ईमेल, कार्यालय समय, सुविधाएँ, सोशल लिंक,
  प्रधानाचार्य का संदेश, प्रवेश मोड, और CBSE संबद्धता संख्या (पुष्टि होने तक खाली
  छोड़ें — कभी प्लेसहोल्डर न डालें)।
- **समय-सारणी** — एक सक्रिय सामान्य अनुसूची, साथ ही वैकल्पिक अस्थायी ओवरराइड।
